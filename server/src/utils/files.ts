...
import { UPLOAD_AVATAR_TEMP_DIR, UPLOAD_IMAGE_TEMP_DIR } from '~/constants/dir'
...
export const handleUploadAvatar = (req: Request): Promise<File[]> => {
  const form = formidable({
    uploadDir: path.resolve(UPLOAD_AVATAR_TEMP_DIR),
    keepExtensions: true,
    maxFiles: 4,
    maxFileSize: 3000 * 1024, // 300kb
    maxTotalFileSize: 3000 * 1024 * 4,
