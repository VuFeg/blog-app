                ...
                <div className="bg-white w-[540px] pb-6 rounded-3xl border shadow-lg ">
                    <div className="flex p-4">
                        <div className="flex flex-1 flex-col border-b pb-2">
                            ...
                            <div>
                                <button className="hover:rounded-full p-2  hover:bg-gray-300"><PiLockKeyThin /></button>
                    ...
                    <div className='flex items-center justify-between '>
                        ...
                        <span className="relative p-4"><div className="pointer-events-auto h-6 w-10 rounded-full p-1 ring-1 ring-inset transition duration-200 ease-in-out bg-slate-900/10 ring-slate-900/5"><div className="h-4 w-4 rounded-full bg-white shadow-sm ring-1 ring-slate-700/10 transition duration-200 ease-in-out" /></div><div className="z-0"><div className="absolute -top-full bottom-2/3 left-0 w-px bg-slate-900/[0.2] [mask-image:linear-gradient(to_top,transparent,white_4rem,white_calc(100%-4rem),transparent)]" /></div></span>
                    </div>
                    <div className='text-center '>
                        <button className='bg-black text-white w-5/6 center border px-4 py-1 pb-3 rounded-md'>Xong</button>
                    </div>
                </div>
            </div>
        </div>
