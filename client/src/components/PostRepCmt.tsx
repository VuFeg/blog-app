    ...
    return (
                ...
                <div className="bg-white rounded-3xl border shadow-lg">
                    ...
                    <div className="flex flex-1 gap-5 p-4 border-b">
                        ...
                        <div className="flex flex-1 flex-col gap-3">
                            <div className="flex flex-1 justify-between font-bold">
                                zuduong
                                <p> <button className="hover:rounded-full p-2  hover:bg-gray-300">
                                    <MdMoreHoriz />
                                </button>
                                </p>
                            </div>
                            <div className='flex'>
                                <input className="flex-1 outline-none" type="text" placeholder="Trả lời wnhu..." />
                            </div>
                    ...
                    <div className="flex items-center gap-5 p-4 mb-4 border-b cursor-pointer justify-between">
                        <span className='opacity-60'>Bất kỳ ai cũng có thể trả lời và trích dẫn</span>
        ...
        <div className="flex items-center gap-5 p-4 mb-4 border-b">
          <input
            className="flex-1 "
            type="text"
            placeholder="Bất kỳ ai cũng có thể trả lời và trích dẫn"
          />
          <button className=" border px-4 py-1 rounded-md">Đăng</button>
        </div>
      </div>
